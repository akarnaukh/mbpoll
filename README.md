...
- **Функции чтения Modbus**: FC 2: Input Bits (дискретные входы), FC 3: Holding Registers (регистры хранения), FC 4: Input Registers (входные регистры)
- **Функции записи Modbus**: FC 5: Write Single Coil, FC 6: Write Single Register, FC 15: Write Multiple Coils, FC 16: Write Multiple Registers
